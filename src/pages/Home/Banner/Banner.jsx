    ...
    return (
        <div id="home" className='py-8 md:py-0 md:h-[400px] md:flex items-center justify-center gap-10 bg-black text-white md:w-10/12 mx-auto'>
            <div className='md:w-5/12'>
                <img className='h-72 w-72 rounded-full border-2 p-2 border-white md:ml-20' src={profile} alt="" />
            </div>
            <div className='md:w-7/12'>
                <h1 className='name text-3xl mt-8 md:mt-0 md:text-5xl font-bold'>Muhim Uddin Tanim</h1>
                <p className='md:w-10/12 my-5'>Passionate about MERN development, I thrive on pushing boundaries, embracing challenges, and delivering cutting-edge solutions that exceed expectations.</p>
